...
static NSString * cellId = @"RegiestTableViewCellId";
...
-(void)provied{
    [[AFHttpClient sharedAFHttpClient]provedWithUserid:@"" token:@"" phone:_emailTextfield.text type:@"register" complete:^(BaseModel *model) {
        if (model) {
            [self timeout];
...
//    sender.userInteractionEnabled = NO;
    ...
    [[AFHttpClient sharedAFHttpClient]registWithphone:_emailTextfield.text password:_passwordTextfield.text complete:^(BaseModel *model) {
        if (model) {
